---
description: Interroga una feature del board, detecta las decisiones que omitiste y siembra su requirements.md. Uso: /afinar-feature <key de la feature (QC-14)>
agent: leader
---
...
preguntas. Pon tu recomendación como primera opción y etiquétala `(Recomendado)`. Si solo hay un
hueco, haz una pregunta.
...
escríbelo en el issue** con las herramientas MCP de `atlassian` (en opencode se registran con el
prefijo `atlassian_*`, no las llames por nombre pelado). Recién entonces siembras.
